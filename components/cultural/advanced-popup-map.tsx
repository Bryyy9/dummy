...
const REGIONS: Region[] = [
  ...
  // panaragan
  {
    ...
    pathData: "M1001 360L997 372L997.5 380.5L1004.5 381.5L1001 390.5L1004.5 402L1009.5 404.5L1015.5 417V427.5L1024.5 421.605L1029.5 411.5L1044 407L1059.5 402L1066.41 391.5L1073.5 386.5L1077 375L1063.5 368.5L1050 373L1040.5 368.5L1029.5 364.5L1015.5 368.5L1001 360Z"
  }
]
    ...
    <div className="relative w-full h-full">
      ...
      <AnimatePresence>
        {hoveredRegion && currentRegion && (
          ...
          >
            <div className="bg-card/95 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-border overflow-hidden w-[360px]">
              <div 
              ...
              <div className="grid grid-cols-3 gap-px bg-border">
                ...
                <div className="bg-card p-3 text-center">
                  ...
                  <p className="text-xs font-semibold text-foreground">
                    {currentRegion.highlights.length}
                  </p>
              ...
              <div className="p-4 space-y-3">
                ...
                <Button 
                  ...
                  onClick={() => onRegionClick?.(currentRegion.id)}
                >
                  Explore Glossary
