        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[75vh]">
          ...
          <div className="space-y-8">
            ...
            <AnimatedReveal animation="fade-up" delay={400}>
              <h1 className="text-6xl font-bold text-white drop-shadow-md">Discover the Spirit of East Java</h1>
              <p className="text-gray-300 text-lg leading-relaxed max-w-lg mt-4">
                ...
                horizons. East Java invites you to a journey filled with beauty, tradition, and adventure.</p>
            </AnimatedReveal>
...
// import { AnimatedReveal } from "@/components/common/animated-reveal";
// import { Badge } from "@/components/ui/badge";
// import { ArrowRight, Mountain, Landmark, Waves, Sparkles } from "lucide-react";
...
//   const [namaCulture, setNamaCulture] = useState("East Java");
//   const [assets, setAssets] = useState<Asset[]>([]);

//   useEffect(() => {
//     const fetchData = async () => {
//       try {
//         const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/public/cultures/1`);
//         const data = await res.json();
//         setNamaCulture(data.namaBudaya);
//         setAssets(data.assetsSubculture);
//       } catch (err) {
//         console.error(err);
//       }
//     };
...
//     "/mount-bromo-sunrise-volcanic-landscape-east-java.jpg",
//     "/malang-traditional-architecture-and-cultural-herit.jpg",
//     "/surabaya-modern-city-with-traditional-cultural-ele.jpg",
//     "/east-java-temple-sunset-landscape-with-traditional.jpg",
//   ];

//   const displayImages = assets.length > 0 ? assets.map((a) => a.url) : fallbackImages;

//   return (
//     <section id="beranda" className="pt-24 pb-20 relative overflow-hidden min-h-screen text-white">
//       {/* Background */}
//       <div className="absolute inset-0">
//         <div
//           className="absolute inset-0 bg-cover bg-center bg-no-repeat"
//           style={{
//             backgroundImage: `linear-gradient(rgba(17,24,39,0.8),rgba(17,24,39,0.8)), url('${displayImages[3]}')`,
//           }}
//         />
//       </div>
...
//                 Discover the Spirit of {namaCulture}
//               </h1>
//               <p className="text-gray-300 text-lg leading-relaxed max-w-lg mt-4">
//                 Experience the harmony of nature and heritage — from sacred temples to volcanic
//                 horizons. {namaCulture} invites you to a journey filled with beauty, tradition, and
//                 adventure.
//               </p>
//             </AnimatedReveal>
...
//                 <div key={i} className="relative h-36 rounded-2xl overflow-hidden shadow-lg group">
//                   <img
//                     src={img}
//                     alt={`Culture image ${i}`}
//                     className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
