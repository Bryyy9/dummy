          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="flex items-center gap-2">
                ...
                <PronunciationButton audioFile={entry!.audioFile} term={entry!.term} size="md" variant="ghost" />
              </div>
              <Badge variant="outline" className="text-xs font-mono bg-muted/50 text-muted-foreground border-border/50">
                {entry!.termCode}
              </Badge>
            </div>
            {entry!.transliterasi && (
              <p className="text-sm text-muted-foreground font-mono">
                Transliteration: <span className="text-foreground">{entry!.transliterasi}</span>
              </p>
            )}
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        <section aria-label="Additional information" className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {entry!.transliterasi && (
            <Card className="bg-card/60 border-border">
              <CardHeader>
                <CardTitle className="text-foreground">Transliteration</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between">
                  <p className="text-sm leading-relaxed text-muted-foreground font-mono">{entry!.transliterasi}</p>
                  <PronunciationButton audioFile={entry!.audioFile} term={entry!.term} size="sm" variant="outline" />
                </div>
              </CardContent>
            </Card>
          )}
          ...
          <Card className="bg-card/60 border-border">
            ...
            <CardContent>
              <p className="text-sm leading-relaxed text-muted-foreground">{entry!.variants}</p>
            </CardContent>
          </Card>
