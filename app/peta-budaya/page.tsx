...
const eastJavaRegions = [
  {
    ...
    description:
      "Urban coastal subculture with egalitarian and expressive Arek traditions.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Island identity with strong traditions, communal solidarity, and pesantren (Islamic boarding school) culture.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Core Madura subculture emphasizing everyday traditions and weaving.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Bawean island subculture with maritime traditions and a local language.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Kangean with a coastal identity and eastern island cultural networks.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Mataraman Javanese subculture: refined etiquette, gamelan, and wayang.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description: "Osing/Using with a distinctive Banyuwangi language and arts.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Panaragan local identity closely tied to folk arts and woodcraft.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    culturalElements: [
      "Dialek Pandalungan",
      "Perpaduan Jawa-Madura",
      "Tradisi Pesisir",
    ],
    description:
      "Jawa-Madura blend in the horseshoe region: distinctive dialect and coastal traditions.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Samin community known for its ethics of honesty and simple agrarian life.",
    population: "—",
    established: "—",
  ...
  },
  {
    ...
    description:
      "Tengger mountain community with the Kasada ritual and the Bromo landscape.",
    population: "—",
    established: "—",
    ...
    if (query.trim()) {
      const results = eastJavaRegions.filter(
        (region) =>
          ...
          region.culturalElements.some((element) =>
            ...
            <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-end pb-8 md:pb-10">
              ...
              >
                ...
                <Link href="/budaya/daerah/-">
                  <Button
                    variant="outline"
                    className="bg-white/10 backdrop-blur-sm border-white/30 text-foreground hover:bg-white/20"
                  >
          ...
          >
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 text-sm text-muted-foreground">
              <li className="flex items-start gap-3">
                ...
                Hover and click any region on the map to highlight cultural
              ...
              <li className="flex items-start gap-3">
                ...
                Gunakan kolom pencarian untuk menemukan istilah-istilah regional
                dan definisinya.
              </li>
              <li className="flex items-start gap-3">
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 text-foreground text-xs font-semibold">
                ...
                Open a region to view a full profile with identity, history, and
                significance.
              </li>
            </ul>
          </motion.div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-card/50 backdrop-blur-sm rounded-xl shadow-sm border border-border p-6 sticky top-24">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Search regional terms and click a result to highlight it on
                  the map.
                </p>
                  ...
                  {showSearchResults && (
                    ...
                    >
                      <SearchResults
                        ...
                        onResultClick={handleRegionClick}
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
            ...
            <div className="lg:col-span-3">
                ...
                <div className="p-4 border-b border-border bg-gradient-to-r from-primary/10 to-accent/10 bg-background">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Click a region to view cultural details
                      </p>
                    </div>
                    <Tooltip>
                      <TooltipTrigger>
                      ...
                      <TooltipContent>
                        <p className="text-sm">
                          Use scroll to zoom, drag to navigate
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
              ...
              <AnimatePresence>
                {selectedRegion && (
                  ...
                  >
                    {(() => {
                      const region = eastJavaRegions.find(
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-4">
                            <h3 className="text-xl font-bold text-foreground">
                              {region.name} — Local Glossary
                            </h3>
                            <Link href={`/budaya/daerah/${region.id}`}>
                              <Button className="bg-primary hover:bg-primary/90">
                                Open Subculture Page
                              </Button>
                            </Link>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            {terms.length === 0 && (
                              <p className="text-sm text-muted-foreground">
                                There are no glossary entries for this
                                subculture yet.
                              </p>
                            )}
                            {terms.length > 6 && (
                              <div className="text-center pt-2">
                                <Link href={`/culture/region/${region.id}`}>
